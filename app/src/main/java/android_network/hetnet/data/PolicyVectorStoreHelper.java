...
public class PolicyVectorStoreHelper extends SQLiteOpenHelper {
    ...
    public static final String[] TABLE_ROWS = {
            COLUMN_ID, COLUMN_APP_ID, COLUMN_LOCATION, COLUMN_SSID, COLUMN_BANDWIDTH,
    ...
    public long storePolicyVector(PolicyRuleVector v) {
        // Gets the data repository in write mode
        SQLiteDatabase db = this.getWritableDatabase();
        // Create a new map of values, where column names are the keys
        ContentValues values = new ContentValues();
        values.put(this.COLUMN_APP_ID, v.getApplicationId());
        values.put(this.COLUMN_LOCATION, v.getLocation().toString());
    ...
    public PolicyRuleVector getPolicyVector(int id) {
        ...
        PolicyRuleVector vector = new PolicyRuleVector(cursor.getString(0),
                new Location(cursor.getString(1)), cursor.getString(2), Integer.parseInt(cursor.getString(3)),
    ...
    // Get PolicyRuleVectors stored in the database
    public List<PolicyRuleVector> getAllStoredPolicyVectors() {
        List<PolicyRuleVector> policyVectorList = new ArrayList<PolicyRuleVector>();
